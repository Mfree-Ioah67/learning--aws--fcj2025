...
3. [Prerequisites (Alternative)](5.2-prerequiste/)
4. [Deploy Infrastructure with CloudFormation](5.3-deploy-infrastructure/)
5. [Configure and Deploy Backend Application](5.4-deploy-backend/)
6. [Deploy Frontend to S3 and CloudFront](5.5-deploy-frontend/)
7. [Testing and Validation](5.6-testing/)
8. [Monitoring and Troubleshooting](5.7-monitoring/)
9. [CI/CD Pipeline Setup](5.8-cicd-pipeline/)
10. [Clean Up Resources](5.9-cleanup/)
