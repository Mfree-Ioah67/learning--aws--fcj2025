...
3. [Chuẩn bị (Thay thế)](5.2-prerequiste/)
4. [Triển khai Infrastructure với CloudFormation](5.3-deploy-infrastructure/)
5. [Cấu hình và Triển khai Backend Application](5.4-deploy-backend/)
6. [Triển khai Frontend lên S3 và CloudFront](5.5-deploy-frontend/)
7. [Kiểm tra và Xác thực](5.6-testing/)
8. [Giám sát và Xử lý sự cố](5.7-monitoring/)
9. [Thiết lập CI/CD Pipeline](5.8-cicd-pipeline/)
10. [Dọn dẹp tài nguyên](5.9-cleanup/)
